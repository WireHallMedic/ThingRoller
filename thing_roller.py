...
nameDict["dragonborn_male"] = text_files/name_gen.generatorGenerator("text_files/name_dragonborn_male.txt", max = 20)
nameDict["dragonborn_surname"] = text_files/name_gen.generatorGenerator("text_files/name_dragonborn_surname.txt")
nameDict["dwarf_female"] = text_files/name_gen.generatorGenerator("text_files/name_dwarf_female.txt")
nameDict["dwarf_male"] = text_files/name_gen.generatorGenerator("text_files/name_dwarf_male.txt")
nameDict["dwarf_surname"] = text_files/name_gen.generatorGenerator("text_files/name_dwarf_surname.txt")
nameDict["elf_female"] = text_files/name_gen.generatorGenerator("text_files/name_elf_female.txt")
nameDict["elf_male"] = text_files/name_gen.generatorGenerator("text_files/name_elf_male.txt")
nameDict["elf_surname"] = text_files/name_gen.generatorGenerator("text_files/name_elf_surname.txt")
nameDict["european_female"] = text_files/name_gen.generatorGenerator("text_files/name_european_female.txt")
nameDict["european_male"] = text_files/name_gen.generatorGenerator("text_files/name_european_male.txt")
nameDict["european_surname"] = text_files/name_gen.generatorGenerator("text_files/name_european_surname.txt")
nameDict["gnome_female"] = text_files/name_gen.generatorGenerator("text_files/name_gnome_female.txt")
nameDict["gnome_male"] = text_files/name_gen.generatorGenerator("text_files/name_gnome_male.txt")
nameDict["gnome_surname"] = text_files/name_gen.generatorGenerator("text_files/name_gnome_surname.txt")
nameDict["halfling_female"] = text_files/name_gen.generatorGenerator("text_files/name_halfling_female.txt")
nameDict["halfling_male"] = text_files/name_gen.generatorGenerator("text_files/name_halfling_male.txt")
nameDict["halfling_surname"] = text_files/name_gen.generatorGenerator("text_files/name_halfling_surname.txt")
nameDict["orc_female"] = text_files/name_gen.generatorGenerator("text_files/name_orc_female.txt")
nameDict["orc_male"] = text_files/name_gen.generatorGenerator("text_files/name_orc_male.txt")
